...
//             className="bg-white/95 backdrop-blur-sm p-6 border border-gray-100 border-t-4 border-t-[#008446] shadow-md hover:shadow-xl transition-all duration-300 group flex flex-col items-center text-center"
//           >
