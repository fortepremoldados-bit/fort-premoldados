  ...
  return (
    <section id="calculadora" className="py-24 bg-white relative border-b border-gray-200 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="bg-white shadow-2xl flex flex-col lg:flex-row overflow-hidden border border-gray-200 w-full rounded-[10px]">
          <div className="lg:w-7/12 p-6 md:p-10 bg-white">
            ...
            <form onSubmit={handleCalcSubmit} className="space-y-5">
              ...
              {calcData.tipo && (
                <div className="bg-gray-50 border border-[#008446]/30 p-3 animate-in fade-in duration-300 flex items-start gap-3 rounded-[10px]">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                <div>
                  ...
                  <div className="flex gap-2">
                    <label className="flex items-center justify-center gap-1.5 cursor-pointer p-2.5 border border-gray-200 flex-1 hover:bg-gray-50 transition-colors rounded-[10px]">
                      <input 
                ...
                <div>
                  ...
                  <select 
                    ...
                    className="w-full bg-gray-50 border border-gray-300 p-2.5 text-sm focus:outline-none focus:border-[#008446] focus:ring-1 focus:ring-[#008446] transition-all rounded-[10px]"
                  >
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-5 items-end">
                    ...
                    <div className="animate-in fade-in">
                      ...
                      <div className="flex relative">
                        <input 
                          ...
                          className="w-full bg-gray-50 border border-gray-300 p-2.5 pl-3 focus:outline-none focus:border-[#008446] focus:ring-1 focus:ring-[#008446] rounded-[10px]" 
                          placeholder="Ex: 150" 
                        />
                ...
                <div className="md:col-span-1">
                  <button type="submit" className="w-full bg-[#008446] hover:bg-[#1C9C69] text-white font-bold text-sm px-2 py-2.5 transition-colors uppercase tracking-wide flex justify-center items-center gap-2 rounded-[10px] h-[46px]">
              ...
              {!calcResult ? (
                ...
                <div className="space-y-6 animate-in fade-in duration-500">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div className="bg-black/50 border border-[#4E524F] p-3 rounded-[10px]">
