                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                  {Object.entries(PISOS_DATA).map(([key, piso]) => (
                    <div 
                      ...
                      className={`cursor-pointer border-2 overflow-hidden transition-all duration-200 relative group ${calcData.tipo === key ? 'border-[#008446] shadow-md' : 'border-gray-200 hover:border-[#008446]/50'}`}
                    >
