      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-12 mb-16">
        ...
        <div className="lg:col-span-3">
          <div className="flex items-center gap-2 mb-6">
            ...
            <span
              className="font-black text-xl text-white uppercase tracking-tight"
          ...
          {/* <p className="text-gray-400 text-sm max-w-md leading-8">
            Indústria especializada em artefatos de concreto de alto desempenho
            para infraestrutura e pavimentação.
          </p> */}
          ...
          {/* <div className="flex gap-4 mt-8">
            <a
              href="#"
              className="w-10 h-10 rounded-full bg-[#4E524F] flex items-center justify-center text-white hover:bg-[#008446] transition-colors font-bold text-xs"
            >
              IG
            </a>
          </div> */}
        ...
        <div>
          ...
          <ul className="space-y-4 text-gray-400 text-sm">
            <li className="flex items-start gap-3">
              ...
              />
              <span>
                Rua Coronel Durval Souzxa, Lote 02 Quadra H - S/n° 
                <br />
                  Sampaio Correia
                <br />
                  Saquarema
